...
public class KeywordExtractor {
    ...
    public void loadHtml(String urlStr, String asp){
        try {
            if (!urlStr.startsWith("http")){
                urlStr = "http://" + urlStr;
            }
            ...
            byte[] enc = Files.readAllBytes(Paths.get("/home/nidhin/Jump2/jump-classifier/htmls", asp, fileName+".html"));
    ...
    public void setHtmlAndText(String html, String text){
        htmlDoc = html;
        this.text = text;
    }
...
//            HashSet<String> terms = RAKE(new String[]{articleText});
            HashSet<String> terms = BiTrigramKeys(new String[]{articleText.trim()});
            return terms;
...
//        parser.reset();
        ...
        ex.loadStopWordsList("SmartStopListEn");
        ex.loadPunctStopWord("RakePunctDefaultStopList");
